...
$("/html") {
  ...
  $("./head") {
    ...
    insert_top("link", rel: "stylesheet", href: "//code.jquery.com/mobile/1.3.1/jquery.mobile.structure-1.3.1.css")
    insert_top("script", src: asset("javascript/jquery.uranium.js"))
    insert_top("script", src: "//code.jquery.com/mobile/1.3.1/jquery.mobile-1.3.1.min.js")
